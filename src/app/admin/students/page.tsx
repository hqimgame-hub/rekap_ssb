        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <main className="w-full px-6 sm:px-8 py-10 max-w-7xl mx-auto space-y-10 animate-fade-in pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    {/* Add Student Form */}
                    <div className="lg:col-span-4 card-refined p-8 bg-white shadow-sm space-y-8 h-fit">
                        ...
                        <form action={async (formData) => {
                            ...
                            <div className="space-y-2.5">
                                ...
                                <input
                                    ...
                                    className="w-full h-14 px-5 rounded-2xl bg-slate-50 border border-card-border focus:ring-8 focus:ring-primary/5 focus:border-primary outline-none transition-all font-bold text-sm"
                                />
                            </div>
                            <div className="space-y-2.5">
                                ...
                                <div className="relative">
                                    <select
                                        name="classId"
                                        required
                                        className="w-full h-14 px-5 rounded-2xl bg-slate-50 border border-card-border focus:ring-8 focus:ring-primary/5 focus:border-primary outline-none transition-all font-bold text-sm appearance-none cursor-pointer"
                                    >
