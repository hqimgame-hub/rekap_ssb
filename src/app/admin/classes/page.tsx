        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="w-full px-6 sm:px-8 py-10 max-w-7xl mx-auto space-y-10 animate-fade-in pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                    {/* Add Class Form */}
                    <div className="lg:col-span-4 bg-white rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/40 space-y-8 sticky top-24">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-12 pr-4 rounded-xl bg-slate-50 border border-slate-200 text-sm font-bold focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-muted-foreground/40"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
