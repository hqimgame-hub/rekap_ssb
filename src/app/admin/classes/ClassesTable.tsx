...
export default function ClassesTable({ classes }: { classes: ClassData[] }) {
    ...
    return (
        <div className="bg-white  rounded-xl overflow-hidden border border-slate-200  shadow-xl shadow-slate-200/40  transition-all">
            {/* Table Header / Toolbar */}
            <div className="p-6 border-b border-card-border bg-slate-50/50  flex flex-col md:flex-row items-center justify-between gap-4 min-h-[80px]">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                    ...
                    <span className="px-3 py-1 rounded-full bg-white  border border-card-border text-[10px] font-black text-primary uppercase tracking-wider md:mr-12">
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-card-border/50">
                        {classes.length === 0 ? (
                            ...
                            classes.map((c, index) => (
                                <tr key={c.id} className={`group hover:bg-slate-50  transition-colors ${selectedIds.includes(c.id) ? "bg-primary/5" : ""}`}>
                                    ...
                                    <td className="p-5">
                                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100  text-muted-foreground group-hover:bg-white group-hover:shadow-sm transition-all">
                                            <Users size={14} />
